...
function result() {
    ...
    if (document.getElementById("metric").checked) {
        ...
        var weightInPounds = 300;
        var weightInKilograms = Math.round(weightInPounds * 0.453592);
        ...
        var tempInFahrenheit = 94;
        var tempInCelsius = Math.round(((tempInFahrenheit - 32) * 5) / 9);
        
        // STEP 12b: Replace the string '94 fahrenheit' with the updated temperature in °C
        newStory = newStory.replace("94 farenheit", tempInCelsius + " celsius");
    }
